...
const projects = [
  ...
  },
  {
    ...
    description:
      "Mobile food ordering application allowing users to browse restaurants, manage carts, and place orders. Implemented real-time cart updates, order tracking, and backend content management using Sanity.io.",
    image: "/project2.png",
